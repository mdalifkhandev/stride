...
import { TopBar } from '@/time-accuracy/components/GameChrome';
...
export function TimeAccuracyCheckScreen({ onExit, skipIntro = false }: TimeAccuracyCheckScreenProps) {
  ...
  return (
    <SafeAreaView className="flex-1" style={{ backgroundColor: TIME_ACCURACY_THEME.background }}>
      ...
      <TopBar onBack={onExit ?? game.handleExit} />
